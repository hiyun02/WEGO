...
public class JwtTokenProvider {
    ...
    private final IUserService userInfoSsService;
     ...
     */
    public String createToken(String userId, String roles, JwtTokenType tokenType, String userName) {
        ...
        Claims claims = Jwts.claims()
                ...
                .setSubject(userId);// 회원아이디 저장 : PK 저장(userId), 회원이름 저장
    ...
    public String getUserName(String token) {
        ...
        String userName = CmmUtil.nvl((String) Jwts.parser().setSigningKey(secretKey)
